...
import { Network, ShieldAlert, CheckCircle, Layers, Activity, Users, Box } from 'lucide-react';

export default function App() {
  const { data, initializeGraph, selectNode, highlightedNodeId, selectedNode, activeMyth, activateMyth } = useGraphStore();
           ...
           <div className="p-4 overflow-y-auto flex-1">
             {mode === AppMode.EXPLORE && selectedNode ? (
               ...
               <div className="text-center mt-20 text-zinc-600">
                 ...
                 <p className="text-xs font-mono">Wybierz węzeł na grafie</p>
               </div>
             )}
           </div>
        </aside>
